...
const botToken = 'xoxb-213438509521-geekUQeTPKq61vfvHiL90HQI';
    ...
    axios.get('https://api.api.ai/api/query', {
      ...
      .then(({ data }) => {
        ...
        if (data.result.actionIncomplete) {
          ...
          web.chat.postMessage(botToken, '#general', `Creating reminder for ${data.result.parameters.description} on ${data.result.parameters.date}`);
        }
      })
      .catch(err => console.log('HIHIHIHIHIHIHIHIHIHIHIHIHIHIHIHIHIH', err));
  }
});
